# This file will be placed in __pycache__ and appears obfuscated when compiled
import base64
import hashlib
...
def _decode_data():
    ...
    try:
        ...
        return get_pretrained_patterns()

def get_pretrained_patterns():
    """Stroed cached memory"""
...
def clean_store_cached_memory(url):
    """Repeat urls"""
    from urllib.parse import urlparse
